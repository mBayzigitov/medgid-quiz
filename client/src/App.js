        ...
        <div>
          <div class="main-container">
            <div className='centered-text'>
              <img id='logo' src='logo.png'></img>
              <h4>Здравствуйте!</h4>
              <p><b>Вы</b> пожелали пройти данный опросник и теперь у Вас есть возможность получить консультацию специалиста! Данное тестирование происходит
                с использованием ресурса сайта <a href="https://medgid.pro" target="_blank">medgid.pro</a></p>
